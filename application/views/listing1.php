			...
			<div class="listing-item">
				...
				<div class="listing-content">
					...
					<div class="listing-title">
						<h4><a href="">Meridian Villas Shapoorji Paloonji</a></h4>
						<a href="">
							<i class="fa fa-map-marker"></i>
							Marathalli, Bangalore
						</a>

						<a href="" class="details button border">View Details</a>
					</div>
					...
					<div class="listing-footer">
						<a href="#"><i class="fa fa-building"></i> Type Apartments</a>
						<span><i class="fa fa-calendar-o"></i> Possession Ready</span>
					</div>

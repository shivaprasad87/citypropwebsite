		...
		<div class="row">
			<div class="col-lg-12">
				<div class="coming-soon-inner">
					<a href="<?=base_url()?>"><img src="<?=base_url('assets/')?>img/logos/logo.png" alt="logo" style="width: 150px;height: 150px;background-color: white;padding: 5px;"></a>
					<h1>Thank You</h1>

					<div class="clearfix"></div>
					<h6>For Showing Interest In Us<br>
						For More Details<br>
						Call Us on<br>
						<a href="tel:+91<?= $social_links->mobile ?>" style="color: white">+91 <?= $social_links->mobile ?></a></h6>
